...
export const findMostExpensiveItem = (shoppingBasketArr) => {
    const shopBasket = shoppingBasketArr.sort((a, b) => b.price - a.price);
...
export const settotalPrice = (shoppingBasketArr) => {
    const shopTotalPrice = shoppingBasketArr.map((item) => {
        const newItem = {...item };
...
export const totalShoppingBasket = (shoppingBasketArr) => {
    const sumValues = shoppingBasketArr.reduce((a, b) => {
