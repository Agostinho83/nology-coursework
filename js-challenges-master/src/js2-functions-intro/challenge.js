 ...
 * @returns {number} 100
 */
export const findSmallestNumber = (number2, number1) => {
...
export const celsiusToFahrenheit = (tempInCelsius) => {
    const tempInF = (tempInCelsius * 9) / 5 + 32;

    const message = tempInCelsius + " degrees celsius is " + tempInF + " degrees fahrenheit";
...
export const calculateLifetimeSupply = (snickersPerDay, age, maxAge) => {
    ...
    const amountOfSnickeresPerLifetime = (snickersPerDay * 365) * (maxAge - age);

    return amountOfSnickeresPerLifetime;
};
